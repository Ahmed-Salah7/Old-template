        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 card card-primary">
                    ...
                    <div class="card-body">
                        <div class=" row">
                            <label class="col-sm-4 col-form-label">{{__('dashboard.Action')}} :</label>
                            <label class="col-sm-8 col-form-label">{{$activity->description}} </label>
                        </div>
                        <div class=" row">
                            <label class="col-sm-4 col-form-label">{{__('dashboard.Model ID')}} :</label>
                            <label class="col-sm-8 col-form-label">{{$activity->subject_id}} </label>
                        </div>
                        <div class=" row">
                            <label class="col-sm-4 col-form-label">{{__('dashboard.Model Type')}} :</label>
                            <label
                                class="col-sm-8 col-form-label">{{substr($activity->subject_type, strrpos($activity->subject_type, '/') + 11)}} </label>
                        </div>
                        <div class=" row">
                            <label class="col-sm-4 col-form-label">{{__('dashboard.Causer Name')}} :</label>
                            <label
                                class="col-sm-8 col-form-label">{{isset($activity->causer)?$activity->causer->name:'-'}} </label>
                        </div>

                        <div class=" row">
                            <label class="col-sm-4 col-form-label">{{__('dashboard.Causer Type')}} :</label>
                            <label
                        ...
                        <div class=" row">
                            <label class="col-sm-4 col-form-label">{{__('dashboard.Updates')}} :</label>
                            <label
