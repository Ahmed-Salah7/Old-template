...
@section('content')
    ...
    <section class="content">
        <div class="container">
            ...
            @include('administration.partial.title',['title'=>__('dashboard.Show Administration Account Details'),'edit_link'=>'admin.administration.edit','delete_link'=>'admin.administration.destroy' , 'model_id'=>$administration->id])
                        ...
                        <div class=" row">
                            ...
                            @if(!empty($administration->getRoleNames()))
                                @foreach($administration->getRoleNames() as $role)
                                    <span
                                        class="col-form-label badge-permissions badge badge-success">{{ $role }}</span>
                                @endforeach
                            @endif
                        </div>
                    </div>
